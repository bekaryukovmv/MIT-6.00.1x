...
# One way is recursively, where the greatest common denominator of a and b can be calculated
# as gcd(a, b) = gcd(b, a mod b). Hint: remember the mod symbol is % in Python.
...
# Спасибо лекциям Тимофея Хирьянова за элегантное решение!
def gcd(a, b):
    """
